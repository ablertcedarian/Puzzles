...
current = 70000000 - totalSize
needed = 30000000 - current
smallest = totalSize 
for key in sizemin.keys():
    print(sizemin[key] - needed)
    if sizemin[key] >= needed:
        smallest = min(smallest, sizemin[key])
        print(f"updating {smallest}")
print(needed, totalSize)
print(smallest)